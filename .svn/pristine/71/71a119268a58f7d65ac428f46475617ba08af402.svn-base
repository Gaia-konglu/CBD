...
<h4>续约外部合约:</h4>
		...
		<div class="form-body">
			...
			<form action="updatethirdparkcontract.do" method="post" name="channelform"  onsubmit="return validate_channel_info(this);">
				<div class="form-group">
					...
					<div class="form-group">
						<label for="number"> 原合同编号：</label> <input type="text"
							...
							value="<%=session.getAttribute("oldnums")%>">
					</div>
					...
					<div class="form-group">
						<label for="number"> 新合同编号：</label> <input type="text"
							...
							value="<%=session.getAttribute("thirdnum")%>">
					</div>
				...
				<input readOnly="true" style="height:30px;width:200px" class="Wdate" type="text" id="startDate" name="startDate"
					...
					<div class="form-group">
					<label for="endtime"> 合约截止日期：</label> 
