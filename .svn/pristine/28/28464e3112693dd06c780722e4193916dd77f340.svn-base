...
<td style= " color:red "> ${requestScope.map.pass} </td>
</tr> 
<tr>
<td>手机号码</td>
<td><input type="text" name="phone" /></td>
<td style= " color:red "> ${requestScope.map.phone} </td>
</tr> 
<tr>
<td colspan="2"><input type="checkbox" checked/>我已看过并接受<a >《用户协议》</a></td>
</tr> 
<tr>
<td colspan="2"> <button type="submit">修改</button> </td>
<td style= " color:red "> ${requestScope.map.Success} </td>
</tr> 
</table> 
</form>
