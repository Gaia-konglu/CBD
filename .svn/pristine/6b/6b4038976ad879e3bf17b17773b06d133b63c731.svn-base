...
<shiro:hasPermission name="contractMP">
 ...
 <shiro:hasPermission name="carportMP">
		...
		<div id="page-wrapper">
			...
			<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
					<form action="updateCarport.do" method="post" onsubmit="return checkEmpty()">
						<div class="form-group">
                           ...
                           <span id="addressinput"> <input name="adress"
								type="text" class="form-control" id="adress"
								placeholder="车位地址" value="<%=request.getParameter("address") %>" oninput="checkAdress()"> </span>
							
							<span  style="color:red;" id="addressmassage"></span>
						</div>
						<div class="form-group" style="clear:both;">
							<label for="exampleInputPassword1">  车位编号：</label>
							 <input name="carNum"
								type="text" class="form-control" id="carNum"
								placeholder="  车位编号：" value="<%=request.getParameter("number") %>">
								<span id="nummes"  style="color:red;"></span>
						</div>
						<input type="hidden" name="id" value="<%=request.getParameter("id") %>">
						<div class="selects"> 
						<label for="exampleInputPassword1">  车位状态：</label>
             ...
             <option value="未出租">未出租</option>
					...
					<br>	<br><br><button type="submit" class="btn btn-default" id="sub" >确认修改</button>
					</form>
					 ${adressException}
				</div>
					</div>
 ...
 <input type="text" name="adress" value="${carportbean.adress }"><br>
   ...
   --%>
	...
	+"id='adress'  placeholder='  车位地址：'  oninput='checkAdress()'>";
	...
	function checkEmpty(){
	 	var content= $("#adress").val();
	 	 	var content2= $("#carNum").val();
	if(content==""){
	 $("#addressmassage").html("地址不能少于10个字");
	 return false;
	}
	if(content2==""){
	 $("#nummes").html("车位编号不能为空");
	 return false;
	}
