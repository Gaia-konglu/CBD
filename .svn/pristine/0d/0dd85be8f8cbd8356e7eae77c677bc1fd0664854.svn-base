...
<label for="exampleInputFile">请上传合同复印件</label>
<form action="uploadthirdparkcontract.do" method="post" enctype="multipart/form-data" name="channelform"  onsubmit="return validate_channel_info(this);">
