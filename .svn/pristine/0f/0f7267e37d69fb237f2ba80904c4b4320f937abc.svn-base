...
<title>Home</title>
<base href="<%=basePath%>">
    <meta http-equiv="refresh" content="3;url=/CBDParkingManagementSystem/jsp/showAllBackStage2.jsp" />
...
<shiro:hasPermission name="contractMP">
 ...
 <shiro:hasPermission name="carportMP">
	...
	<div class="container">
		<h3>提示内容</h3>
		<p>
			<span>页面自动跳转到查询页面</span> <a href="/CBDParkingManagementSystem/jsp/showAllBackStage2.jsp">跳转</a> <span>等待时间：</span>
