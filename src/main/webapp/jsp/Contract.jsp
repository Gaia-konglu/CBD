...
<shiro:hasPermission name="contractMP">
 ...
 <shiro:hasPermission name="carportMP">
		...
		<div style="float:left" >
			<form action="selectresult.do">
			请选择合同状态信息:
				<select id="FirstCate" name="FirstCate" class="form-control1" style="width:200px">
					<option>----请--选--择----</option>
					<option>状态正常</option>
					<option>即将到期</option>
					<option>已过期</option>
		...
		<div style="float:left;margin-left:50px">
			<form action="selectresultByname.do">
			    请输入企业名称：<input type="text" id="companyname" name="companyname" style="height:35px;width:200px">
			    <input type="submit" value="查询">
			</form>
		</div>
		...
		<table class="table table-hover" border=1 id="middle"
  ...
  <!--  <a href="/CBDParkingManagementSystem/updateaddpage.do">新加</a>-->
    ...
    <script type="text/javascript">
					...
					function showContracts(ppage) {
						$.ajax({
									url : "/CBDParkingManagementSystem/selectCompanyContract.do",
									type : "post",
									...
									success : function(data) {
										...
										for (var i = 0; i < contract.length; i++) {
											...
											content += "<tbody>" + "<tr>"
													...
													+ g.status
													+ "</td>"
													+ "<td><a  href='/CBDParkingManagementSystem/updateContractpage.do?contractid="
													+ g.id
													+ "' ><button type='submit'>"
													+ "续约</button></a></td>"
													+ "</tr>" + "</tbody>";
