...
<shiro:hasPermission name="contractMP">
 ...
 <shiro:hasPermission name="carportMP">
		...
		<div id="page-wrapper">
			<!-- 内容填充 -->
 <input type="hidden" id="contractid" name="contractid"   value="${param.contractid}"  />
    
    <table class="table table-hover" id="middle" border=1>
    </table>
    <div class="bottom" style="text-align:center;margin-top:100px">
   
      <button id="firstpage" onclick="showCarport(1)">首页</button>
   ...
   <script type="text/javascript">
    //显示车位信息
		function showCarport(ppage){
	$.ajax({
		url:"/CBDParkingManagementSystem/ThirdParkContract.do",
	type:"post",
	...
	data:JSON.stringify(ppage),
		...
		success:function(data){
			var carport=data.thirdcarport;
			var totalPage=data.totalpage;
			var content="<thead style='text-align:center'>"+"<tr>"+
			"<th>序号</th>"+
			"<th>车位地址信息</th>"+
            "<th>车位编号</th>"+
            "</tr>"+
			...
			for(var i=0;i<carport.length;i++){
				var g=carport[i];
				content+="<tbody>"+
				"<tr>"+
				"<td>"+(i+1)+"</td>"+
