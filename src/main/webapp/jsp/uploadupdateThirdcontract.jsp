...
<font size=4><label>第三方合约信息更改成功,请上传与该企业新签订合约复印件</label></font>
<form action="uploadthirdxueyue.do" method="post" enctype="multipart/form-data" name="channelform"  onsubmit="return validate_channel_info(this);">
...
<script type="text/javascript">
      ...
      function validate_channel_info(channelform) { 
             var strs = new Array();  
             //var pic1 = document.getElementById(imgFile);  
            ...
            fileSize = document.getElementById("imgFile").files[0].size / 1024;
                if (fileSize > 1000) {
                alert("您选择的图片太大，请选择小于1M的图片"); 
                return false;      
             }  
