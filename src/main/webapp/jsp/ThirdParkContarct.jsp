...
<div class="form-title">
 ...
 <table  class="table table-hover" border=1 id="middle" style="text-align:center">
   ...
   <script type="text/javascript">
	...
	$.ajax({
		url:"/CBDParkingManagementSystem/selectThirdContract.do",
	type:"post",
	...
	data:JSON.stringify(ppage),
		...
		success:function(data){
			var contract=data.thirdparkcontract;
        ...
        "</thead>";
			...
			for(var i=0;i<contract.length;i++){
				...
				"<tr>"+
				         ...
				         "<td>"+g.contacts+"</td>"+
				         "<td>"+g.phone+"</td>"+
				         "<td><a href='/CBDParkingManagementSystem/changethirdcontractpage.do?contractid="+g.id+"'>查看</a></td>"+
				         "<td>"+g.startTime+"</td>"+
				         "<td>"+g.endTime+"</td>"+
				         "<td><a href='/CBDParkingManagementSystem/selectthirdparkcontractcopy.do?contractid="+g.id+"'>查看</a></td>"+
				         "<td>"+g.status+"</td>"+
				         "<td><a href='/CBDParkingManagementSystem/changeupdatethirdContractpage.do?contractid="+g.id+"' ><button type='submit'>"+
				         "续约</button></a></td>"+
				         "</tr>"+
				         "</tbody>";
			}
