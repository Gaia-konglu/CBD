...
<font size=4><label>企业租赁合同更改成功,请上传与该企业新签订合约复印件</label></font>
<form action="uploadxueyue.do" method="post" enctype="multipart/form-data" name="channelform"  onsubmit="return validate_channel_info(this);">
