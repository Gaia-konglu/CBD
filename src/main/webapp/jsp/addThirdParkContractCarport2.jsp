...
<shiro:hasPermission name="contractMP">
 ...
 <shiro:hasPermission name="carportMP">
		...
		<font size="4">第三方合约信息录入成功，请添加车位信息！</font><br/>
		合同id<%=session.getAttribute("thirdparkcontractid") %>
		<a  href="/CBDParkingManagementSystem/jsp/addcarport2.jsp?thirdparkcontractid=<%=session.getAttribute("thirdparkcontractid")%>">添加车位编号</a>
		<a  href="/CBDParkingManagementSystem/jsp/addManyCarport2.jsp?thirdparkcontractid=<%=session.getAttribute("thirdparkcontractid")%>">批量添加车位编号</a>
