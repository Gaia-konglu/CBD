 ...
 <shiro:hasPermission name="carportMP">
		...
		<div id="page-wrapper">
			...
			<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
					<form action="addSingleCarport.do" method="post" onsubmit="return checkEmpty()">
						<div class="form-group">
                           ...
                           <span id="addressinput"> <input name="adress"
								...
								placeholder="车位地址" value="${carportbean.adress }" oninput="checkAdress()"> </span>
                        ...
                        <input type="hidden" name="tpc.id" value="${thirdparkcontractid }">
